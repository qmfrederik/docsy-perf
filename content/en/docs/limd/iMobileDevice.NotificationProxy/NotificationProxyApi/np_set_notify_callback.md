---
title: NotificationProxyApi.np_set_notify_callback method
---
...
```csharp
public virtual NotificationProxyError np_set_notify_callback(NotificationProxyClientHandle client, 
