---
title: NotificationProxyNativeMethods.np_observe_notification method
---

Tells the device to send a notification on the specified event.

```csharp
public static NotificationProxyError np_observe_notification(NotificationProxyClientHandle client, 
    string notification)
```
