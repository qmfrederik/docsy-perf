---
title: iDeviceApi.idevice_connection_receive_timeout method
---
...
```csharp
public virtual iDeviceError idevice_connection_receive_timeout(iDeviceConnectionHandle connection, 
