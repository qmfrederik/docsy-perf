---
title: iDeviceApi.idevice_connection_send method
---

Send data to a device via the given connection.

```csharp
public virtual iDeviceError idevice_connection_send(iDeviceConnectionHandle connection, 
    byte[] data, uint len, ref uint sentBytes)
```
