---
title: IiDeviceApi.idevice_connection_receive method
---
...
```csharp
public iDeviceError idevice_connection_receive(iDeviceConnectionHandle connection, byte[] data, 
    uint len, ref uint recvBytes)
```
