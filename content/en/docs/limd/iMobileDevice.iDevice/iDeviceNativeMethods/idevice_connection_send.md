---
title: iDeviceNativeMethods.idevice_connection_send method
---

Send data to a device via the given connection.

```csharp
public static iDeviceError idevice_connection_send(iDeviceConnectionHandle connection, byte[] data, 
