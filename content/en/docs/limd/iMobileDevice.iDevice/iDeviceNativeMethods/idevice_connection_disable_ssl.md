---
title: iDeviceNativeMethods.idevice_connection_disable_ssl method
---

Disable SSL for the given connection.

```csharp
public static iDeviceError idevice_connection_disable_ssl(iDeviceConnectionHandle connection)
```
