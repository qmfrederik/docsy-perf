---
title: InstallationProxyNativeMethods.instproxy_client_start_service method
---

Starts a new installation_proxy service on the specified device and connects to it.

```csharp
public static InstallationProxyError instproxy_client_start_service(iDeviceHandle device, 
