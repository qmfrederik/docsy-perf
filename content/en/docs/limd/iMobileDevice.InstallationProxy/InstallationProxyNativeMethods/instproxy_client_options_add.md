---
title: InstallationProxyNativeMethods.instproxy_client_options_add method (1 of 2)
---
...
---
title: InstallationProxyNativeMethods.instproxy_client_options_add method (2 of 2)
---

```csharp
public static void instproxy_client_options_add(PlistHandle client_options, string key, 
    string value, byte term)
```
