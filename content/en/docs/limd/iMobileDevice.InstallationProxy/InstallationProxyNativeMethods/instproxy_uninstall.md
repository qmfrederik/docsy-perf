---
title: InstallationProxyNativeMethods.instproxy_uninstall method
---

Uninstall an application from the device.

```csharp
public static InstallationProxyError instproxy_uninstall(InstallationProxyClientHandle client, 
