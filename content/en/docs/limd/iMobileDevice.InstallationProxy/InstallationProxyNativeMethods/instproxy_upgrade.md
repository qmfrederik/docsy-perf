---
title: InstallationProxyNativeMethods.instproxy_upgrade method
---
...
```csharp
public static InstallationProxyError instproxy_upgrade(InstallationProxyClientHandle client, 
