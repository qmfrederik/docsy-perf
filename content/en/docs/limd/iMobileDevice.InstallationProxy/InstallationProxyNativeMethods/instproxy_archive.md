---
title: InstallationProxyNativeMethods.instproxy_archive method
---
...
```csharp
public static InstallationProxyError instproxy_archive(InstallationProxyClientHandle client, 
