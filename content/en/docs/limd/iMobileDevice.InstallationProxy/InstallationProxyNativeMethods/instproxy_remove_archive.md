---
title: InstallationProxyNativeMethods.instproxy_remove_archive method
---
...
```csharp
public static InstallationProxyError instproxy_remove_archive(InstallationProxyClientHandle client, 
