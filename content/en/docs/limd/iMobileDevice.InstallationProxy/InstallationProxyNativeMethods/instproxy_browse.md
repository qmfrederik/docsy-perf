---
title: InstallationProxyNativeMethods.instproxy_browse method
---

List installed applications. This function runs synchronously.

```csharp
public static InstallationProxyError instproxy_browse(InstallationProxyClientHandle client, 
