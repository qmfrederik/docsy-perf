---
title: InstallationProxyNativeMethods.instproxy_status_get_error method (1 of 2)
---

Gets error name, code and description from a response if available.

```csharp
public static InstallationProxyError instproxy_status_get_error(PlistHandle status, 
    out IntPtr name, out IntPtr description, ref ulong code)
```
...
---
title: InstallationProxyNativeMethods.instproxy_status_get_error method (2 of 2)
---

```csharp
public static InstallationProxyError instproxy_status_get_error(PlistHandle status, 
    out string name, out string description, ref ulong code)
```
