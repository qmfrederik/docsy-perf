---
title: IInstallationProxyApi.instproxy_remove_archive method
---
...
```csharp
public InstallationProxyError instproxy_remove_archive(InstallationProxyClientHandle client, 
