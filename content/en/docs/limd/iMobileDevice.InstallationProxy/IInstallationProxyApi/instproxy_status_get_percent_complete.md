---
title: IInstallationProxyApi.instproxy_status_get_percent_complete method
---

Gets progress in percentage from a status if available.

```csharp
public void instproxy_status_get_percent_complete(PlistHandle status, ref int percent)
```
