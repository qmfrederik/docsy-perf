---
title: IInstallationProxyApi.instproxy_client_options_set_return_attributes method
---

Adds attributes to the given client_options to filter browse results.

```csharp
public void instproxy_client_options_set_return_attributes(PlistHandle clientOptions)
```
