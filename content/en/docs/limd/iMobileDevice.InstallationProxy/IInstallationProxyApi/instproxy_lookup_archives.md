---
title: IInstallationProxyApi.instproxy_lookup_archives method
---

List archived applications. This function runs synchronously.

```csharp
public InstallationProxyError instproxy_lookup_archives(InstallationProxyClientHandle client, 
