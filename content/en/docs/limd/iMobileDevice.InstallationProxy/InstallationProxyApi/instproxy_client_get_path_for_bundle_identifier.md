---
title: InstallationProxyApi.instproxy_client_get_path_for_bundle_identifier method
---

Queries the device for the path of an application.

```csharp
public virtual InstallationProxyError instproxy_client_get_path_for_bundle_identifier(
