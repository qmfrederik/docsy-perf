---
title: InstallationProxyApi.instproxy_browse_with_callback method
---

List pages of installed applications in a callback.

```csharp
public virtual InstallationProxyError instproxy_browse_with_callback(
    InstallationProxyClientHandle client, PlistHandle clientOptions, 
