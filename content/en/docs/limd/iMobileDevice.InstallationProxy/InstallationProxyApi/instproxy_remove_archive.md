---
title: InstallationProxyApi.instproxy_remove_archive method
---
...
```csharp
public virtual InstallationProxyError instproxy_remove_archive(
    InstallationProxyClientHandle client, string appid, PlistHandle clientOptions, 
    InstallationProxyStatusCallBack statusCallBack, IntPtr userData)
```
