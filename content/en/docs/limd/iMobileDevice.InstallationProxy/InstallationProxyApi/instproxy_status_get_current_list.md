---
title: InstallationProxyApi.instproxy_status_get_current_list method
---

Gets total and current item information from a browse response if available.

```csharp
public virtual void instproxy_status_get_current_list(PlistHandle status, ref ulong total, 
