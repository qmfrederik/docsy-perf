---
title: RestoreNativeMethods.restored_start_restore method
---

Requests to start a restore and retrieve it's port on success.

```csharp
public static RestoreError restored_start_restore(RestoreClientHandle client, PlistHandle options, 
    ulong version)
```
