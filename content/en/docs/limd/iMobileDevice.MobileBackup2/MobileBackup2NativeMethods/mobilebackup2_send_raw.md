---
title: MobileBackup2NativeMethods.mobilebackup2_send_raw method
---

Send binary data to the device.

```csharp
public static MobileBackup2Error mobilebackup2_send_raw(MobileBackup2ClientHandle client, 
