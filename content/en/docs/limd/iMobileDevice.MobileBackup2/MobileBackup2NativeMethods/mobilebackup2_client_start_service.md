---
title: MobileBackup2NativeMethods.mobilebackup2_client_start_service method
---

Starts a new mobilebackup2 service on the specified device and connects to it.

```csharp
public static MobileBackup2Error mobilebackup2_client_start_service(iDeviceHandle device, 
