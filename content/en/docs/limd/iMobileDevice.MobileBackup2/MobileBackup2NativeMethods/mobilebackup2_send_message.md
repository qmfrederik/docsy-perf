---
title: MobileBackup2NativeMethods.mobilebackup2_send_message method
---

Sends a backup message plist.

```csharp
public static MobileBackup2Error mobilebackup2_send_message(MobileBackup2ClientHandle client, 
