---
title: MobileBackup2NativeMethods.mobilebackup2_receive_raw method
---

Receive binary from the device.

```csharp
public static MobileBackup2Error mobilebackup2_receive_raw(MobileBackup2ClientHandle client, 
