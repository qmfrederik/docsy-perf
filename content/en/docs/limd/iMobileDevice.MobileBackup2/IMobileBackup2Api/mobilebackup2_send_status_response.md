---
title: IMobileBackup2Api.mobilebackup2_send_status_response method
---

Sends a DLMessageStatusResponse to the device.

```csharp
public MobileBackup2Error mobilebackup2_send_status_response(MobileBackup2ClientHandle client, 
    int statusCode, string status1, PlistHandle status2)
```
