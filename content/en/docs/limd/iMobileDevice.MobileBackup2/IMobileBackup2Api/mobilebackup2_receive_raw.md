---
title: IMobileBackup2Api.mobilebackup2_receive_raw method
---

Receive binary from the device.

```csharp
public MobileBackup2Error mobilebackup2_receive_raw(MobileBackup2ClientHandle client, byte[] data, 
    uint length, ref uint bytes)
```
