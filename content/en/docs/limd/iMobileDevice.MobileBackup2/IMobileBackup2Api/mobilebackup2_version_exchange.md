---
title: IMobileBackup2Api.mobilebackup2_version_exchange method
---

Performs the mobilebackup2 protocol version exchange.

```csharp
public MobileBackup2Error mobilebackup2_version_exchange(MobileBackup2ClientHandle client, 
