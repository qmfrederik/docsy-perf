---
title: SpringBoardServicesNativeMethods.sbservices_get_interface_orientation method
---

Gets the interface orientation of the device.

```csharp
public static SpringBoardServicesError sbservices_get_interface_orientation(
