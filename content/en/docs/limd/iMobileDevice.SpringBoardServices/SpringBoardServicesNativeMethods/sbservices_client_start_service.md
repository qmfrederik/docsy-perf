---
title: SpringBoardServicesNativeMethods.sbservices_client_start_service method
---

Starts a new sbservices service on the specified device and connects to it.

```csharp
public static SpringBoardServicesError sbservices_client_start_service(iDeviceHandle device, 
