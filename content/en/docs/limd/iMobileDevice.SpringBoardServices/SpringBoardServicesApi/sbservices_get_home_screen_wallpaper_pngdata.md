---
title: SpringBoardServicesApi.sbservices_get_home_screen_wallpaper_pngdata method
---

Get the home screen wallpaper as PNG data.

```csharp
public virtual SpringBoardServicesError sbservices_get_home_screen_wallpaper_pngdata(
