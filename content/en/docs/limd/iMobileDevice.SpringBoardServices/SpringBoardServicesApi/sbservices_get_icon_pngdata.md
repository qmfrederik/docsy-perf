---
title: SpringBoardServicesApi.sbservices_get_icon_pngdata method
---

Get the icon of the specified app as PNG data.

```csharp
public virtual SpringBoardServicesError sbservices_get_icon_pngdata(
    SpringBoardServicesClientHandle client, string bundleid, ref IntPtr pngdata, ref ulong pngsize)
```
