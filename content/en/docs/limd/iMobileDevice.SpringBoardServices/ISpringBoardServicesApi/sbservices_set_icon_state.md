---
title: ISpringBoardServicesApi.sbservices_set_icon_state method
---

Sets the icon state of the connected device.

```csharp
public SpringBoardServicesError sbservices_set_icon_state(SpringBoardServicesClientHandle client, 
    PlistHandle newstate)
```
