---
title: ISpringBoardServicesApi.sbservices_get_home_screen_wallpaper_pngdata method
---

Get the home screen wallpaper as PNG data.

```csharp
public SpringBoardServicesError sbservices_get_home_screen_wallpaper_pngdata(
