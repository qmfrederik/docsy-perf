---
title: ISpringBoardServicesApi.sbservices_get_icon_state method
---

Gets the icon state of the connected device.

```csharp
public SpringBoardServicesError sbservices_get_icon_state(SpringBoardServicesClientHandle client, 
    out PlistHandle state, string formatVersion)
```
