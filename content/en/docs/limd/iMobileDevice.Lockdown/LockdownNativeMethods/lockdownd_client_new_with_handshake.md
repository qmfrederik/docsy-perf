---
title: LockdownNativeMethods.lockdownd_client_new_with_handshake method
---
...
```csharp
public static LockdownError lockdownd_client_new_with_handshake(iDeviceHandle device, 
