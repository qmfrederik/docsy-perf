---
title: LockdownNativeMethods.lockdownd_start_service method
---

Requests to start a service and retrieve it's port on success.

```csharp
public static LockdownError lockdownd_start_service(LockdownClientHandle client, string identifier, 
    out LockdownServiceDescriptorHandle service)
```
