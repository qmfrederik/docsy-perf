---
title: LockdownNativeMethods.lockdownd_start_service_with_escrow_bag method
---

Requests to start a service and retrieve it's port on success. Sends the escrow bag from the device's pair record.

```csharp
public static LockdownError lockdownd_start_service_with_escrow_bag(LockdownClientHandle client, 
