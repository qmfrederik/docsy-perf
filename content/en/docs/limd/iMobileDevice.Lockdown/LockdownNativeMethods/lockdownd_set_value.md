---
title: LockdownNativeMethods.lockdownd_set_value method
---

Sets a preferences value using a plist and optional by domain and/or key name.

```csharp
public static LockdownError lockdownd_set_value(LockdownClientHandle client, string domain, 
    string key, PlistHandle value)
```
