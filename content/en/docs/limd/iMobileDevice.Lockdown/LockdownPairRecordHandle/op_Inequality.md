---
title: LockdownPairRecordHandle Inequality operator
---

Determines whether two specified instances of [`LockdownPairRecordHandle`](../LockdownPairRecordHandle.md) are not equal.
