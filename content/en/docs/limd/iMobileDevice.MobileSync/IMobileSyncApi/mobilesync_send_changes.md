---
title: IMobileSyncApi.mobilesync_send_changes method
---
...
```csharp
public MobileSyncError mobilesync_send_changes(MobileSyncClientHandle client, PlistHandle entities, 
    char isLastRecord, PlistHandle actions)
```
