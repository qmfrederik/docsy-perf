---
title: IMobileSyncApi.mobilesync_acknowledge_changes_from_device method
---
...
```csharp
public MobileSyncError mobilesync_acknowledge_changes_from_device(MobileSyncClientHandle client)
```
