---
title: IMobileSyncApi.mobilesync_clear_all_records_on_device method
---
...
```csharp
public MobileSyncError mobilesync_clear_all_records_on_device(MobileSyncClientHandle client)
```
