---
title: MobileSyncNativeMethods.mobilesync_remap_identifiers method
---
...
```csharp
public static MobileSyncError mobilesync_remap_identifiers(MobileSyncClientHandle client, 
