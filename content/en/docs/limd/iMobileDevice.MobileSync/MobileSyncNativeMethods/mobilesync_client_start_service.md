---
title: MobileSyncNativeMethods.mobilesync_client_start_service method
---

Starts a new mobilesync service on the specified device and connects to it.

```csharp
public static MobileSyncError mobilesync_client_start_service(iDeviceHandle device, 
