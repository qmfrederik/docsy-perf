---
title: MobileSyncNativeMethods.mobilesync_get_all_records_from_device method
---
...
```csharp
public static MobileSyncError mobilesync_get_all_records_from_device(MobileSyncClientHandle client)
```
