---
title: WebInspectorNativeMethods.webinspector_client_start_service method
---

Starts a new webinspector service on the specified device and connects to it.

```csharp
public static WebInspectorError webinspector_client_start_service(iDeviceHandle device, 
