---
title: IWebInspectorApi.webinspector_receive_with_timeout method
---

Receives a plist using the given webinspector client.

```csharp
public WebInspectorError webinspector_receive_with_timeout(WebInspectorClientHandle client, 
