---
title: WebInspectorApi.webinspector_receive_with_timeout method
---

Receives a plist using the given webinspector client.

```csharp
public virtual WebInspectorError webinspector_receive_with_timeout(WebInspectorClientHandle client, 
