---
title: HouseArrestNativeMethods.house_arrest_send_command method
---

Send a command to the connected house_arrest service. Calls house_arrest_send_request() internally.

```csharp
public static HouseArrestError house_arrest_send_command(HouseArrestClientHandle client, 
