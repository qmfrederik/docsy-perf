---
title: HouseArrestNativeMethods.house_arrest_client_start_service method
---

Starts a new house_arrest service on the specified device and connects to it.

```csharp
public static HouseArrestError house_arrest_client_start_service(iDeviceHandle device, 
