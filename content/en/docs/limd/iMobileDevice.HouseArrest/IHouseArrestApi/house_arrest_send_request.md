---
title: IHouseArrestApi.house_arrest_send_request method
---

Sends a generic request to the connected house_arrest service.

```csharp
public HouseArrestError house_arrest_send_request(HouseArrestClientHandle client, PlistHandle dict)
```
