---
title: HeartBeatNativeMethods.heartbeat_receive_with_timeout method
---

Receives a plist using the given heartbeat client.

```csharp
public static HeartBeatError heartbeat_receive_with_timeout(HeartBeatClientHandle client, 
