---
title: SyslogRelayClientHandle Inequality operator
---

Determines whether two specified instances of [`SyslogRelayClientHandle`](../SyslogRelayClientHandle.md) are not equal.
