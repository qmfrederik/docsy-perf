---
title: SyslogRelayApi.syslog_relay_receive_with_timeout method
---

Receives data using the given syslog_relay client with specified timeout.

```csharp
public virtual SyslogRelayError syslog_relay_receive_with_timeout(SyslogRelayClientHandle client, 
