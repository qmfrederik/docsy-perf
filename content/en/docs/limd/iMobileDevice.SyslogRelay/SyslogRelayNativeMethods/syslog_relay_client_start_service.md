---
title: SyslogRelayNativeMethods.syslog_relay_client_start_service method
---

Starts a new syslog_relay service on the specified device and connects to it.

```csharp
public static SyslogRelayError syslog_relay_client_start_service(iDeviceHandle device, 
