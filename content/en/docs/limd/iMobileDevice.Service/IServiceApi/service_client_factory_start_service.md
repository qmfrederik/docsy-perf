---
title: IServiceApi.service_client_factory_start_service method
---

Starts a new service on the specified device with given name and connects to it.

```csharp
public ServiceError service_client_factory_start_service(iDeviceHandle device, string serviceName, 
    ref IntPtr client, string label, ref ConstructorFunc constructorFunc, ref int errorCode)
```
