---
title: ServiceNativeMethods.service_client_factory_start_service method
---

Starts a new service on the specified device with given name and connects to it.

```csharp
public static ServiceError service_client_factory_start_service(iDeviceHandle device, 
