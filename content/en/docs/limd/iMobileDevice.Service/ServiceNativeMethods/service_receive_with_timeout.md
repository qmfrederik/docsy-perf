---
title: ServiceNativeMethods.service_receive_with_timeout method
---

Receives data using the given service client with specified timeout.

```csharp
public static ServiceError service_receive_with_timeout(ServiceClientHandle client, byte[] data, 
