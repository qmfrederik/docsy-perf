---
title: IAfcApi.afc_client_new method
---

Makes a connection to the AFC service on the device.

```csharp
public AfcError afc_client_new(iDeviceHandle device, LockdownServiceDescriptorHandle service, 
    out AfcClientHandle client)
```
