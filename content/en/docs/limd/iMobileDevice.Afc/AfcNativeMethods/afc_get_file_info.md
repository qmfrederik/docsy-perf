---
title: AfcNativeMethods.afc_get_file_info method (1 of 2)
---

Gets information about a specific file.

```csharp
public static AfcError afc_get_file_info(AfcClientHandle client, string filename, 
...
---
title: AfcNativeMethods.afc_get_file_info method (2 of 2)
---
