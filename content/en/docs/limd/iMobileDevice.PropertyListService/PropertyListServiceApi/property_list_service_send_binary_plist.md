---
title: PropertyListServiceApi.property_list_service_send_binary_plist method
---

Sends a binary plist.

```csharp
public virtual PropertyListServiceError property_list_service_send_binary_plist(
