---
title: PropertyListServiceApi.property_list_service_receive_plist_with_timeout method
---
...
```csharp
public virtual PropertyListServiceError property_list_service_receive_plist_with_timeout(
