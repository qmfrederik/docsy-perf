---
title: IPropertyListServiceApi.property_list_service_client_new method
---

Creates a new property list service for the specified port.

```csharp
public PropertyListServiceError property_list_service_client_new(iDeviceHandle device, 
