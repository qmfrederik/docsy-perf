---
title: PropertyListServiceNativeMethods.property_list_service_receive_plist_with_timeout method
---
...
```csharp
public static PropertyListServiceError property_list_service_receive_plist_with_timeout(
