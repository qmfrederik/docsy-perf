---
title: PropertyListServiceNativeMethods.property_list_service_client_free method
---

Frees a PropertyList service.

```csharp
public static PropertyListServiceError property_list_service_client_free(IntPtr client)
```
