---
title: PropertyListServiceNativeMethods.property_list_service_client_new method
---

Creates a new property list service for the specified port.

```csharp
public static PropertyListServiceError property_list_service_client_new(iDeviceHandle device, 
