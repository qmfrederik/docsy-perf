---
title: IDiagnosticsRelayApi.diagnostics_relay_shutdown method
---

Shutdown of the device and optionally show a user notification.

```csharp
public DiagnosticsRelayError diagnostics_relay_shutdown(DiagnosticsRelayClientHandle client, 
