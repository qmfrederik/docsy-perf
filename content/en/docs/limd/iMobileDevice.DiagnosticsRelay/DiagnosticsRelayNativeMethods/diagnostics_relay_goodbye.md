---
title: DiagnosticsRelayNativeMethods.diagnostics_relay_goodbye method
---

Sends the Goodbye request signaling the end of communication.

```csharp
public static DiagnosticsRelayError diagnostics_relay_goodbye(DiagnosticsRelayClientHandle client)
```
