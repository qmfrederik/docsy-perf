---
title: DiagnosticsRelayNativeMethods.diagnostics_relay_restart method
---

Restart the device and optionally show a user notification.

```csharp
public static DiagnosticsRelayError diagnostics_relay_restart(DiagnosticsRelayClientHandle client, 
