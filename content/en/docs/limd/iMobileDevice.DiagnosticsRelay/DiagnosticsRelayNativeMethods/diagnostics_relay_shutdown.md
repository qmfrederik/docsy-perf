---
title: DiagnosticsRelayNativeMethods.diagnostics_relay_shutdown method
---

Shutdown of the device and optionally show a user notification.

```csharp
public static DiagnosticsRelayError diagnostics_relay_shutdown(DiagnosticsRelayClientHandle client, 
