---
title: DiagnosticsRelayNativeMethods.diagnostics_relay_request_diagnostics method
---

Shutdown of the device and optionally show a user notification.

```csharp
public static DiagnosticsRelayError diagnostics_relay_request_diagnostics(
    DiagnosticsRelayClientHandle client, string type, out PlistHandle diagnostics)
```
