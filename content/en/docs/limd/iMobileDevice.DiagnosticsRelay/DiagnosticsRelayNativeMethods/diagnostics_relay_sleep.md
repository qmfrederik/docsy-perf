---
title: DiagnosticsRelayNativeMethods.diagnostics_relay_sleep method
---

Puts the device into deep sleep mode and disconnects from host.

```csharp
public static DiagnosticsRelayError diagnostics_relay_sleep(DiagnosticsRelayClientHandle client)
```
