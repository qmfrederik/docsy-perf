---
title: DiagnosticsRelayApi.diagnostics_relay_client_start_service method
---

Starts a new diagnostics_relay service on the specified device and connects to it.

```csharp
public virtual DiagnosticsRelayError diagnostics_relay_client_start_service(iDeviceHandle device, 
