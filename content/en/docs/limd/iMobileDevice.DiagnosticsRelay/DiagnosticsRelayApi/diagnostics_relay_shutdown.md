---
title: DiagnosticsRelayApi.diagnostics_relay_shutdown method
---

Shutdown of the device and optionally show a user notification.

```csharp
public virtual DiagnosticsRelayError diagnostics_relay_shutdown(
    DiagnosticsRelayClientHandle client, DiagnosticsRelayAction flags)
```
