---
title: PlistNativeMethods.plist_array_next_item method
---

Increment iterator of a #PLIST_ARRAY node.

```csharp
public static void plist_array_next_item(PlistHandle node, PlistArrayIterHandle iter, 
    out PlistHandle item)
```
