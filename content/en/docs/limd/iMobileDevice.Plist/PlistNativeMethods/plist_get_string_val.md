---
title: PlistNativeMethods.plist_get_string_val method (1 of 2)
---

Get the value of a #PLIST_STRING node. This function does nothing if node is not of type #PLIST_STRING

```csharp
public static void plist_get_string_val(PlistHandle node, out IntPtr val)
```
...
---
title: PlistNativeMethods.plist_get_string_val method (2 of 2)
---
