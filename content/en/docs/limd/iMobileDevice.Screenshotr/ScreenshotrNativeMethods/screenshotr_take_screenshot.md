---
title: ScreenshotrNativeMethods.screenshotr_take_screenshot method
---

Get a screen shot from the connected device.

```csharp
public static ScreenshotrError screenshotr_take_screenshot(ScreenshotrClientHandle client, 
