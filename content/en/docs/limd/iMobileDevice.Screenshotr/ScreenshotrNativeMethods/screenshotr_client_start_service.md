---
title: ScreenshotrNativeMethods.screenshotr_client_start_service method
---

Starts a new screenshotr service on the specified device and connects to it.

```csharp
public static ScreenshotrError screenshotr_client_start_service(iDeviceHandle device, 
