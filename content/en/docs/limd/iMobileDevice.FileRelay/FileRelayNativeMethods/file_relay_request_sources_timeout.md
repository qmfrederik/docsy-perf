---
title: FileRelayNativeMethods.file_relay_request_sources_timeout method (1 of 2)
---
...
```csharp
public static FileRelayError file_relay_request_sources_timeout(FileRelayClientHandle client, 
    out IntPtr sources, out iDeviceConnectionHandle connection, uint timeout)
```
...
---
title: FileRelayNativeMethods.file_relay_request_sources_timeout method (2 of 2)
---
