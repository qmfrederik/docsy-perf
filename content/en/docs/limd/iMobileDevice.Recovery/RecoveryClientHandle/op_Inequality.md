---
title: RecoveryClientHandle Inequality operator
---

Determines whether two specified instances of [`RecoveryClientHandle`](../RecoveryClientHandle.md) are not equal.
