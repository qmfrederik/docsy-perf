---
title: IMobileactivationApi.mobileactivation_create_activation_info_with_session method
---
...
```csharp
public MobileactivationError mobileactivation_create_activation_info_with_session(
