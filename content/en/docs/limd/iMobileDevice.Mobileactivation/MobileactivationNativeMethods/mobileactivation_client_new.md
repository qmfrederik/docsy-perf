---
title: MobileactivationNativeMethods.mobileactivation_client_new method
---

Connects to the mobileactivation service on the specified device.

```csharp
public static MobileactivationError mobileactivation_client_new(iDeviceHandle device, 
