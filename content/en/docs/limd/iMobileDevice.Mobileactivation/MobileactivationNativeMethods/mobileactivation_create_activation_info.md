---
title: MobileactivationNativeMethods.mobileactivation_create_activation_info method
---

Retrieves the activation info required for device activation.

```csharp
public static MobileactivationError mobileactivation_create_activation_info(
