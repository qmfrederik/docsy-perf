---
title: MobileactivationNativeMethods.mobileactivation_create_activation_info_with_session method
---
...
```csharp
public static MobileactivationError mobileactivation_create_activation_info_with_session(
