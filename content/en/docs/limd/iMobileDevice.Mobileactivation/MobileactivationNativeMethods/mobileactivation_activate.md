---
title: MobileactivationNativeMethods.mobileactivation_activate method
---
...
```csharp
public static MobileactivationError mobileactivation_activate(MobileactivationClientHandle client, 
