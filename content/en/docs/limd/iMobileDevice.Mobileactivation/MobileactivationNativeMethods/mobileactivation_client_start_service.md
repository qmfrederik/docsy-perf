---
title: MobileactivationNativeMethods.mobileactivation_client_start_service method
---

Starts a new mobileactivation service on the specified device and connects to it.

```csharp
public static MobileactivationError mobileactivation_client_start_service(iDeviceHandle device, 
