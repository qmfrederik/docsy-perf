---
title: MobileactivationApi.mobileactivation_create_activation_session_info method
---

Retrieves a session blob required for 'drmHandshake' via albert.apple.com.

```csharp
public virtual MobileactivationError mobileactivation_create_activation_session_info(
