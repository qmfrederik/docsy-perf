---
title: MobileBackupApi.mobilebackup_request_restore method
---

Request that a backup should be restored to the connected device.

```csharp
public virtual MobileBackupError mobilebackup_request_restore(MobileBackupClientHandle client, 
