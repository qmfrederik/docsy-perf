---
title: IMobileBackupApi.mobilebackup_send_backup_file_received method
---

Sends a confirmation to the device that a backup file has been received.

```csharp
public MobileBackupError mobilebackup_send_backup_file_received(MobileBackupClientHandle client)
```
