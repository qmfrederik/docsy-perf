---
title: IMobileBackupApi.mobilebackup_send_restore_complete method
---
...
```csharp
public MobileBackupError mobilebackup_send_restore_complete(MobileBackupClientHandle client)
```
