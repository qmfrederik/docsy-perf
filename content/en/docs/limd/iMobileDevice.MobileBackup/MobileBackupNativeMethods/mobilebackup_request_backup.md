---
title: MobileBackupNativeMethods.mobilebackup_request_backup method
---

Request a backup from the connected device.

```csharp
public static MobileBackupError mobilebackup_request_backup(MobileBackupClientHandle client, 
