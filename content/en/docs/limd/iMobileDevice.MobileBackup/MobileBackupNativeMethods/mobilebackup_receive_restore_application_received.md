---
title: MobileBackupNativeMethods.mobilebackup_receive_restore_application_received method
---

Receive a confirmation from the device that it successfully received application data file.

```csharp
public static MobileBackupError mobilebackup_receive_restore_application_received(
