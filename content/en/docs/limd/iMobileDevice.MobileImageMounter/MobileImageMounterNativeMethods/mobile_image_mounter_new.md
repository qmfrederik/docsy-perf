---
title: MobileImageMounterNativeMethods.mobile_image_mounter_new method
---

Connects to the mobile_image_mounter service on the specified device.

```csharp
public static MobileImageMounterError mobile_image_mounter_new(iDeviceHandle device, 
