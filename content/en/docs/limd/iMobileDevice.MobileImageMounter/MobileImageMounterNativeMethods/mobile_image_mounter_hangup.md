---
title: MobileImageMounterNativeMethods.mobile_image_mounter_hangup method
---
...
```csharp
public static MobileImageMounterError mobile_image_mounter_hangup(
    MobileImageMounterClientHandle client)
```
