---
title: MobileImageMounterNativeMethods.mobile_image_mounter_start_service method
---

Starts a new mobile_image_mounter service on the specified device and connects to it.

```csharp
public static MobileImageMounterError mobile_image_mounter_start_service(iDeviceHandle device, 
