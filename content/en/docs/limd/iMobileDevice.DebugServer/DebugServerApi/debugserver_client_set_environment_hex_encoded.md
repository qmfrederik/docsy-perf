---
title: DebugServerApi.debugserver_client_set_environment_hex_encoded method
---

Adds or sets an environment variable.

```csharp
public virtual DebugServerError debugserver_client_set_environment_hex_encoded(
