---
title: DebugServerApi.debugserver_client_receive_response method
---

Receives and parses response of debugserver service.

```csharp
public virtual DebugServerError debugserver_client_receive_response(DebugServerClientHandle client, 
    out string response)
```
