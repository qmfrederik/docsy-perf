---
title: DebugServerApi.debugserver_client_send method
---

Sends raw data using the given debugserver service client.

```csharp
public virtual DebugServerError debugserver_client_send(DebugServerClientHandle client, 
    byte[] data, uint size, ref uint sent)
```
