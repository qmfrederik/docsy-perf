---
title: DebugServerClientHandle Inequality operator
---

Determines whether two specified instances of [`DebugServerClientHandle`](../DebugServerClientHandle.md) are not equal.
