---
title: DebugServerCommandHandle Inequality operator
---

Determines whether two specified instances of [`DebugServerCommandHandle`](../DebugServerCommandHandle.md) are not equal.
