---
title: IDebugServerApi.debugserver_client_receive_with_timeout method
---

Receives raw data using the given debugserver client with specified timeout.

```csharp
public DebugServerError debugserver_client_receive_with_timeout(DebugServerClientHandle client, 
