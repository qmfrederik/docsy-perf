---
title: IDebugServerApi.debugserver_client_set_argv method
---

Sets the argv which launches an app.

```csharp
public DebugServerError debugserver_client_set_argv(DebugServerClientHandle client, int argc, 
    ReadOnlyCollection<string> argv, out string response)
```
