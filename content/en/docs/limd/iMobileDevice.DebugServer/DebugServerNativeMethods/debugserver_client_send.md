---
title: DebugServerNativeMethods.debugserver_client_send method
---

Sends raw data using the given debugserver service client.

```csharp
public static DebugServerError debugserver_client_send(DebugServerClientHandle client, byte[] data, 
