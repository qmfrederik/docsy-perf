---
title: DebugServerNativeMethods.debugserver_client_start_service method
---

Starts a new debugserver service on the specified device and connects to it.

```csharp
public static DebugServerError debugserver_client_start_service(iDeviceHandle device, 
