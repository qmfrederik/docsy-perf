---
title: DebugServerNativeMethods.debugserver_client_set_ack_mode method
---

Controls status of ACK mode when sending commands or receiving responses.

```csharp
public static DebugServerError debugserver_client_set_ack_mode(DebugServerClientHandle client, 
    int enabled)
```
